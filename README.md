...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytube-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14035&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytube-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytube` can be installed with:

```
conda install pytube
```

It is possible to list all of the versions of `pytube` available on your platform with:
